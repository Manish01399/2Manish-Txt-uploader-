...
AUTH_USER = os.environ.get('AUTH_USERS', '7261277639').split(',')
...
photologo = 'https://tinypic.host/image/1000123171.3Koddw' #https://envs.sh/GV0.jpg
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Manish_0139")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Channel", url="https://t.me/+sjGGT5ughqYxYmVl"),
            InlineKeyboardButton(text="🛠️ Group", url="https://t.me/+JanpxW3-LSRmNjQ1"),
        ],
    ]
)
...
async def text_handler(bot: Client, m: Message):
    ...
    try:
            ...
            try:
                cc = f'🎞️𝐓𝐢𝐭𝐥𝐞 » `{name} [{res}].mp4🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 » `{CREDIT}`'
